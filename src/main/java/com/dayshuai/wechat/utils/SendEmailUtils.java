...
public class SendEmailUtils {
     ...
     * 发送简单的文本邮件
     */
    public void sendTextEmail(String to, String wechatNo, String title) throws Exception {
        ...
        String content = String.format("公众号：%s内容更新，title:%S。", wechatNo, title);
        // 设置纯文本内容为邮件正文
     ...
     * 发送简单的html邮件
     */
    public boolean sendHtmlEmail(String to, String wechatNo, String articleUrl) throws Exception {
        try {
            // 创建Session实例对象
            Session session = Session.getInstance(props, new MyAuthenticator(username, password));
